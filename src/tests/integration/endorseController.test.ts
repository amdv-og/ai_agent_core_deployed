...
jest.mock("../../application/useCases/endorseUseCase");

describe("EndorseController Integration", () => {
    let app: any;
    let useCaseMock: jest.Mocked<EndorseUseCase>;
    const url = "/endorse/test-session";
    ...
    beforeAll(() => {
        ...
        useCaseMock = new (EndorseUseCase as any)();
        ...
        Container.set(EndorseUseCase, useCaseMock);
